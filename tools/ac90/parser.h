...
int parser__is_end_of_many(struct parser *parser);
...
int parser__is_typedef_name(struct parser *parser, struct token *tk);
int parser__is_enumeration_constant(struct parser *parser, struct token *tk);

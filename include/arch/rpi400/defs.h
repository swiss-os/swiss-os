...
#define KERNEL_MAX_SIZE (1024 * 1024 * 4)
...
#define MEM_PAGE_TABLE1		(MEM_FIQ_STACK + EXCEPTION_STACK_SIZE * (CORES-1) + 5 * PAGE_SIZE)
...
#define MEM_HEAP_SIZE       (0x40000000 - MEM_HEAP_START)
#define MEM_PROG_END        MEM_PAGE_TABLE1_END
#define MEM_LOWMEM_END      0x78000000ULL
#define MEM_HIGHMEM_START		GIGABYTE
#define MEM_HIGHMEM_END			(3ULL * GIGABYTE - 1)
...
#define MEM_PCIE_DMA_RANGE_PCIE_START 0ULL /* or  0x400000000ULL */
